[![Run App Wachendorf, Evan](https://github.com/EvanWach/GithubActions/actions/workflows/ci.yml/badge.svg)](https://github.com/EvanWach/GithubActions/actions/workflows/ci.yml)
